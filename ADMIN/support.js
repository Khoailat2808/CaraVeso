    ...
    <article class="review-row ${isExpanded ? 'focused' : ''}">
      <div class="review-row-main">
        <div class="product-cell">
          <img src="${review.san_pham.thumbnail || 'support-assets/product-sofa.png'}" alt="${escapeHtml(review.san_pham.ten_san_pham)}">
...
function buildConversations(){
  const base = [
    { id:'conv-thanh', name:'Nguyễn Tiến Thành', avatar:'Image/z8035902214819_031ff1a69d59b3b3287ba9a5e278fef0.jpg', time:'10:30 AM', snippet:'Cái bàn ăn hôm nay em nhận bên mình...', group:'read', review:createVirtualReview('Nguyễn Tiến Thành','Image/z8035902214819_031ff1a69d59b3b3287ba9a5e278fef0.jpg','Bàn ăn Signature Walnut','Mẫu gỗ rất đẹp. Bộ bàn chắc chắn, phù hợp căn hộ 2 phòng ngủ.',5) },
    { id:'conv-dat', name:'Nguyễn Tiến Đạt', avatar:'Image/z8035902384682_68d785f2e177f72491431b8f891ecf80.jpg', time:'10:15 AM', snippet:'Bạn: Dạ shop đã tiến hành gửi thông tin...', group:'read', review:createVirtualReview('Nguyễn Tiến Đạt','Image/z8035902384682_68d785f2e177f72491431b8f891ecf80.jpg','Ghế Sofa CaraVeso','Bạn: Dạ shop đã tiến hành gửi thông tin hỗ trợ.',4) },
    { id:'conv-hoang', name:'Hoàng Huy Tiến', avatar:'Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg', time:'7:00 PM', snippet:'Đã gửi 3 ảnh.', group:'unread', unread:0, review:createVirtualReview('Hoàng Huy Tiến','Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg','Ghế Sofa Milano','Nhưng khi mình ngồi thử thì thấy nó bị lún và phát ra tiếng kêu khá khó chịu á',4,true) },
    { id:'conv-tra-my', name:'Trà My Lê', avatar:'Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg', time:'6:45 PM', snippet:'Dạ Nguyễn Tiến Đạt á shop.', group:'unread', unread:2, review:createVirtualReview('Trà My Lê','Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg','Ghế Sofa CaraVeso','Dạ Nguyễn Tiến Đạt á shop.',4) },
    { id:'conv-vinh', name:'Nguyễn Quang Vinh', avatar:'Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg', time:'6:40 PM', snippet:'Shop nhanh nhanh giúp tôi cái nha chứ...', group:'unread', unread:2, review:createVirtualReview('Nguyễn Quang Vinh','Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg','Nệm Kymdan','Shop nhanh nhanh giúp tôi cái nha chứ sản phẩm bị lỗi khá bất tiện.',3) },
    { id:'conv-duy', name:'Trần Phước Duy', avatar:'Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg', time:'6:35 PM', snippet:'Có 2,5cm á shop.', group:'unread', unread:3, review:createVirtualReview('Trần Phước Duy','Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg','Tủ quần áo','Có 2,5cm á shop.',3) },
    { id:'conv-khoa', name:'Trần Anh Khoa', avatar:'Image/z8035902546352_17d1c6a379de5f5a97e86ed7da01083d.jpg', time:'10:20 AM', snippet:'Ok shop nhé.', group:'read', review:createVirtualReview('Trần Anh Khoa','Image/z8035902546352_17d1c6a379de5f5a97e86ed7da01083d.jpg','Bàn ăn Signature Walnut','Ok shop nhé.',5) },
    { id:'conv-thao', name:'Huỳnh Thất Thảo', avatar:'Image/z8035902881534_7461087ca3f33524f700b10a1c49ee3e.jpg', time:'9:53 AM', snippet:'Ý là bị vấp á shop ơi...', group:'read', review:createVirtualReview('Huỳnh Thất Thảo','Image/z8035902881534_7461087ca3f33524f700b10a1c49ee3e.jpg','Ghế Sofa CaraVeso','Ý là bị vấp á shop ơi...',3) }
  ];
...
function createVirtualReview(name, avatar, productName, content, stars, hasProof=false){
  return {
    ...
    san_pham:{ ten_san_pham:productName, phan_loai:'Ghế 2 chỗ, Trắng Kem', thumbnail:'support-assets/product-sofa.png' },
    so_sao:stars,
    noi_dung_danh_gia:content,
    hinh_anh_minh_chung: hasProof ? ['support-assets/proof-sofa-1.png','support-assets/proof-sofa-2.png','support-assets/proof-sofa-3.png'] : [],
...
function renderProofMessage(conversation){
  const review = conversation.review;
  const images = review.hinh_anh_minh_chung.length ? review.hinh_anh_minh_chung : ['support-assets/proof-sofa-1.png','support-assets/proof-sofa-2.png','support-assets/proof-sofa-3.png'];
  return `
...
function buildFallbackReviews(){
  const products = [
    ['Bàn ăn Signature Walnut','Bàn ăn','Gỗ óc chó, 4 ghế','support-assets/product-table.png'],
    ['Ghế Sofa CaraVeso','Ghế Sofa','Ghế 2 chỗ, Trắng Kem','support-assets/product-sofa.png'],
    ['Ghế Sofa Milano Shape U','Ghế Sofa','Sofa chữ U, Trắng Kem','support-assets/product-l-sofa.png'],
    ['Nệm Kymdan','Nệm','1m8 x 2m, Cao su tự nhiên','support-assets/product-mattress.png'],
    ['Bộ bàn học trẻ em','Bàn ăn','Gỗ sáng, 4 ghế','support-assets/product-dining.png']
  ];
  const customers = [
    ['Hoàng Huy Tiến','Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg'],['Nguyễn Tiến Thành','Image/z8035902214819_031ff1a69d59b3b3287ba9a5e278fef0.jpg'],['Nguyễn Tiến Đạt','Image/z8035902384682_68d785f2e177f72491431b8f891ecf80.jpg'],['Trần Anh Khoa','Image/z8035902546352_17d1c6a379de5f5a97e86ed7da01083d.jpg'],['Huỳnh Thất Thảo','Image/z8035902881534_7461087ca3f33524f700b10a1c49ee3e.jpg']
  ];
  const comments = [
  ...
  return Array.from({length:50},(_,i)=>{
    ...
    return {
      ...
      hinh_anh_minh_chung:i%2===0?['support-assets/proof-sofa-1.png','support-assets/proof-sofa-2.png','support-assets/proof-sofa-3.png']:[],
