...
const FALLBACK_DATA = [
  {
    ...
    "chi_tiet_san_pham": {
      ...
      "hinh_anh_minh_chung": [
        "aftersales-assets/proof1.png",
        "aftersales-assets/proof2.png",
        "aftersales-assets/proof3.png"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    "khach_hang": {
      "ho_ten": "Trần\nAnh Khoa",
      "avatar": "Image/z8035903698384_cc93c53b4275dc90ffa9608ded350e61.jpg",
...
async function init() {
  try {
    const res = await fetch("aftersales-data.json", { cache: "no-store" });
    if (!res.ok) throw new Error("Không đọc được aftersales-data.json");
    ...
    showToast("Đang dùng dữ liệu dự phòng. Nếu muốn đọc aftersales-data.json trực tiếp, hãy mở bằng Live Server.");
  }
...
function renderRow(item) {
  ...
  const avatar = item.khach_hang?.avatar || "Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg";
