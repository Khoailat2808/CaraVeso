...
// Logic chính: đọc aftersales-data.json, lọc giao nhiều điều kiện, phân trang, mở chi tiết và cập nhật trạng thái trực tiếp.
...
const FALLBACK_DATA = [
  ...
  },
  {
    ...
    "khach_hang": {
      "ho_ten": "Trần\nAnh Khoa",
      "avatar": "../shared/Image/z8035903698384_cc93c53b4275dc90ffa9608ded350e61.jpg",
...
async function init() {
  try {
    const res = await fetch("../../data/admin/aftersales-data.json", { cache: "no-store" });
    if (!res.ok) throw new Error("Không đọc được dữ liệu hậu mãi");
    ...
    showToast("Đang dùng dữ liệu dự phòng. Nếu muốn đọc dữ liệu trực tiếp, hãy mở bằng Live Server.");
  }
...
function renderRow(item) {
  ...
  const avatar = item.khach_hang?.avatar || "../shared/Image/z8035902036779_91f5c3755db42487914a1f8d431c1122.jpg";
